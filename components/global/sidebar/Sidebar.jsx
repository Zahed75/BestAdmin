...
import { deleteCookie } from "@/components/withAuth";
          ...
          <ul className="flex flex-col py-2">
            ...
            <li>
              <Link
                ...
                className={`flex flex-row items-center duration-700 text-black ${
                  pathname == "/dashboard/products" ? "bg-black text-white" : ""
                } hover:bg-black rounded-xl my-1 py-0 group`}
              >
                <span className="inline-flex items-center justify-center px-2 py-2 text-lg group">
                  <svg
            ...
            <li>
              <Link
                ...
                className={`flex flex-row items-center duration-700 text-black ${
                  pathname == "/dashboard/outlets" ? "bg-black text-white" : ""
                } hover:bg-black rounded-xl my-1 py-0 group`}
              >
                <span className="inline-flex items-center justify-center px-2 py-2 text-lg group">
                  <svg
              ...
              >
                ...
                <li>
                  ...
                  >
                    ...
                    <span className="text-sm mx-3">Banner Setup</span>
                  </Link>
                </li>
                <li>
                  <Link
                  ...
                  >
                    ...
                    <span className="text-sm mx-3">Outlets Setup</span>
                  </Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              <Link
                href="/dashboard/outletslocations"
                className={`flex flex-row items-center duration-700 text-black ${
                  pathname == "/dashboard/outletslocations"
                    ? "bg-black text-white"
                    : ""
                } hover:bg-black rounded-xl my-1 py-0 group`}
              >
            ...
            <li>
              <button
                ...
                className={`flex flex-row items-center duration-700 text-black hover:bg-black rounded-xl my-1 py-0 group w-full`}
              >
                <span className="inline-flex items-center justify-center px-2 py-2 text-lg group">
                  <svg
                    width="24"
