...
export default function TopBar() {
  ...
  `}
    >
      ...
      <aside
        className={`lg:block ${open ? "block" : "hidden"
            ...
            <ul className="flex flex-col py-2">
              <li>
                ...
                >
                  ...
                  <span className="text-sm group-hover:text-white ml-3" onClick={handleOpen}>
                    Dashboard
                  </span>
                </Link>
              </li>
              ...
              <li>
                <Link
                  ...
                  className={`flex flex-row items-center duration-700 text-black ${pathname == "/dashboard/products"
                    ? "bg-black text-white"
                    : ""
                    } hover:bg-black rounded-xl my-1 py-0 group`}
                >
                ...
                >
                  <li>
                    ...
                    >
                      ...
                      <span className="text-sm mx-3" onClick={handleOpen}>Categories</span>
                    </Link>
                  </li>
                </ul>
              </li>
              ...
              <li>
                <Link
                  ...
                  className={`flex flex-row items-center duration-700 text-black ${pathname == "/dashboard/outlets"
                    ? "bg-black text-white"
                    : ""
                    } hover:bg-black rounded-xl my-1 py-0 group`}
                >
              ...
              <li>
                <Link
                  ...
                  className={`flex flex-row items-center duration-700 text-black ${pathname == "/dashboard/settings"
                    ? "bg-black text-white"
                    : ""
                    } hover:bg-black rounded-xl my-1 py-0 group`}
                >
                ...
                >
                  <li>
                    ...
                    >
                      ...
                      <span className="text-sm mx-3" onClick={handleOpen}>Page Setup</span>
                    </Link>
                  </li>
                </ul>
              </li>
