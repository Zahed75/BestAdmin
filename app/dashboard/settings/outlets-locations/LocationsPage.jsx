...
export default function LocationsPage({ initialItems }) {
    ...
    // Function to toggle Add New menu
    const toggleAddMenu = () => {
                ...
                <div className="p-6 w-full mx-auto">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="relative">
                            <svg
                                className="absolute left-3 inset-y-0 my-auto h-5 w-5 text-orange-500"
                                fill="none" xmlns="http://www.w3.org/2000/svg">

                                <g id="SVGRepo_bgCarrier" stroke-width="0" />
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" />
                                <g id="SVGRepo_iconCarrier"> <g id="Interface / Search_Magnifying_Glass"> <path id="Vector" d="M15 15L21 21M10 17C6.13401 17 3 13.866 3 10C3 6.13401 6.13401 3 10 3C13.866 3 17 6.13401 17 10C17 13.866 13.866 17 10 17Z" stroke="#F26522" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" /> </g> </g>
                            </svg>
                            <input
                                type="text"
                    ...
                    M0.3,512.69c-1.958,8.812,5.998,16.708,14.811,14.565l119.891-29.069L27.473,390.597L0.3,512.69z" />
                        ...
                        {/* <div className="flex justify-between items-center bg-gray-100 px-4 py-2 rounded">
                            <span className="font-semibold">Aftabnagar</span>
                            <div className="flex space-x-2">
            ...
            <Modal updateModal={() => setShowUpdateMenu(false)}>
                ...
                >
                    <div className="flex justify-center items-center min-h-screen px-4 sm:px-6 lg:px-8">
                        <div className="max-w-lg w-full bg-white p-6 rounded-md shadow-md">
                            <div className="flex justify-between items-center w-full">
                                <span className="text-2xl font-bold">Update Outlet Location</span>
                                <button
